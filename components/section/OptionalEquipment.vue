            ...
            <swiper :class="['optional-equipment__wrapper', { 'slider-touchmove': sliderTouchStart }]"
                ...
                <swiper-slide :class="['optional-equipment__card', item.additionalClass]" :id="item.id" v-for="(item, idx) of optionalEquipmentArr" :key="idx">
                    ...
                    <div class="optional-equipment__card_btns-inner" v-else>
                        <nuxt-link :to="item.pathTo" class="optional-equipment__card_btn blue-border-btn" v-if="item.pathTo">Подробнее</nuxt-link>
                        <button type="button" class="optional-equipment__card_btn blue-border-btn" v-if="item.popup" @click="requestFormPopupStore.open()">Подробнее</button>
                    </div>
                </swiper-slide>
