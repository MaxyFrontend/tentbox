            ...
            <div class="tent--card__sizes">
                <swiper class="tent--card__sizes-slider"
                    ...
                    <swiper-slide class="tent--card__size" v-for="(size, idx) in rentSizes" :key="idx">
                        <nuxt-link :to="`/tent-rent/${size.path}`" :class="['tent--card__size_link', { 'blue-border-btn current--btn-active': currentSizeIdx === idx }, { 'grey-border-btn': currentSizeIdx !== idx }]">
                            {{ size.value }}
                        </nuxt-link>
                    </swiper-slide>
                </swiper>
            ...
            <div class="tent--card__additional tent-rent-card__additional">
                <div class="tent--card__additional_item tent--card__color">
                    ...
                    <div class="tent--card__additional_item_content tent--card__color_content">
                        <div class="tent--card__color_btns-inner">
                            <button :class="['tent--card__color_btn grey-border-btn',
                ...
                <div class="tent--card__additional_item tent--card__options">
                    ...
                    <div class="tent--card__additional_item_content tent--card__options_content">
                        <button :class="['tent--card__options_btn grey-border-btn', { 'is-choosen': TentRentSizesStore.sizes[currentSizeIdx].additional.options[idx].choosen }]" v-for="(option, idx) in data.additional.options" :key="idx" @click="chooseOptionFunc(idx)">
                ...
                <div class="tent--card__additional_item tent--card__days">
                    ...
                    <div class="tent--card__additional_item_content tent--card__days_content">
                        <button :class="['tent--card__days_btn grey-border-btn', { 'is-choosen': TentRentSizesStore.sizes[currentSizeIdx].additional.days[idx].choosen }]" v-for="(day, idx) in data.additional.days" :key="idx" @click="chooseDayFunc(idx)">
                ...
                <div class="tent--card__contact-info_btns-inner">
                    ...
                    <div class="tent--card__contact-info_btn-wrapper overflow--hidden">
                        <div class="tent--card__contact-info_btn-inner"
                            ...
                            <nuxt-link to="/tent-order" class="tent--card__contact-info_btn tent--card__contact-info_order-link grey-border-btn">
                                Купить
                            </nuxt-link>
                        </div>
                    </div>
...
if (!TentRentSizesStore.dataFetched) {
    ...
    TentRentSizesStore.dataFetched
